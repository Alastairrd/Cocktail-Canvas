...
CREATE TABLE IF NOT EXISTS `cocktail_canvas`.`drinkglass` (
  ...
  INDEX `glass_id_idx` (`glass_id` ASC),
  INDEX `drink_id_idx` (`drink_id` ASC),
  CONSTRAINT `drink_id`
...
CREATE TABLE IF NOT EXISTS `cocktail_canvas`.`drinkingredients` (
  ...
  INDEX `drinkid_idx` (`drink_id` ASC),
  INDEX `ingr_id_drink_idx` (`ingr_id` ASC),
...
CREATE TABLE IF NOT EXISTS `cocktail_canvas`.`menus` (
  ...
  PRIMARY KEY (`menu_id`),
  INDEX `menu_user_id_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `cocktail_canvas`.`menudrinks` (
  ...
  INDEX `menu_drink_id_idx` (`drink_id` ASC),
